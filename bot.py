...
BOT_TOKEN = "8449771354:AAF6_ff8ZLNVUk1wYBlVzKTZZFbtYwIlY8I"  # <-- вставьте свой токен
...
# Новый обработчик для "Политика конфиденциальности"
...
# Новый обработчик для "Пользовательское соглашение"
...
# Новый обработчик для "Контакты поддержки"
...
async def contact_support(message: Message):
    await message.answer(
        ...
        "📱 Telegram: @OWNER_AIR\n"
        " Наш тик ток https://www.tiktok.com/@straxozavr?_t=ZS-8yLbVy6QnWp&_r=1"
